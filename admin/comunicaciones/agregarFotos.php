...
if ($infoValidate['estado']) {
    ...
    foreach ($galeria as $key => $imagen) {
         $estadoAgregacion = agregarImagenGaleria($imagen, $carpeta, $id);
    }
   

    if ($estadoAgregacion == 1) {
        $texto = "Las imágenes se han dado de alta correctamente.";
    } else {
        $texto = "Hubo un error al agregar las imágenes. Vuelva a intentarlo en unos minutos.";
    }
} else {
