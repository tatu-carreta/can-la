...
if ($infoValidate['estado']) {
    ...
    $estadoEliminacion = realizarBajaEco($idEco);

    if ($estadoEliminacion) {
        $texto = "El eco en español se ha dado de baja correctamente.";
    } else {
        $texto = "Hubo un error al dar de baja el eco en español. Vuelva a intentarlo en unos minutos.";
    }
} else {
