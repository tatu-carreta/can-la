...
if ($infoValidate['estado']) {
    ...
    $estadoEliminacion = realizarBajaArchivoArea($idArea);

    if ($estadoEliminacion) {
        $texto = "La imagen del área se ha dado de baja correctamente.";
    } else {
        $texto = "Hubo un error al dar de baja la imagen del área. Vuelva a intentarlo en unos minutos.";
    }
} else {
